class UsersController < ApplicationController
    ...
    def create_params(params)
        params.permit(:email, :first_name, :last_name, :password, :password_confirmation, :address, :city, :state, :country, :phone_number, :campaign_id)
    end

    def update_params(params)
        params.permit(:email, :first_name, :last_name, :admin, :position, :address, :city, :state, :country, :phone_number)
    end
end
